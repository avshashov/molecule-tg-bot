...
def rent() -> InlineKeyboardMarkup:
    ...
    kb.add(
        InlineKeyboardButton(
            text=LEXICON_RENT['rental_request'], callback_data='rental_request'
        )
    )
    kb.add(
        InlineKeyboardButton(
...
def send() -> InlineKeyboardMarkup:
    ...
    kb.add(
        InlineKeyboardButton(
            text=LEXICON_RENT['repeat_request'], callback_data='repeat_request'
        )
    )
    kb.adjust(2)
    return kb.as_markup()
...
def cancel_rent() -> InlineKeyboardMarkup:
    ...
    kb.add(
        InlineKeyboardButton(
            text=LEXICON_RENT['cancel_button'], callback_data='cancel_button'
        )
    )
    return kb.as_markup()
